...
import StylistDisplay from "components/testimonials/StylistDisplay.js"
  ...
  render() {
    return(
      <AnimationRevealPage>
        ...
        <StylistDisplay display={this.state.display===null?[{image: PastDesign1, idea: "sample idea"}]: this.state.display}/>
        <Footer />
      </AnimationRevealPage>
    )
  }
