...
class StylistList extends Component{
    ...
    submitInfo(){
        ...
        // this.redirect()})
        // this.redirect();
        this.showStylistList(0,this.state.style,this.state.sort, this.state.search,this.state.limit)
                    ...
                    <div className="flex justify-center my-6 ">
                        <nav>
                            <ul className="flex list-style-none">
                                ...
                                <li class="page-item"><p className="page-link relative block py-1.5 px-3 rounded border-0 bg-transparent outline-none transition-all duration-300 rounded text-gray-800 pointer-events-none focus:shadow-none">{this.state.page+1}</p></li>
...
export default followStylistList
