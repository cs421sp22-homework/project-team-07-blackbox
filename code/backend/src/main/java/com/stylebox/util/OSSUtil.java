...
//    }
     ...
     */
    public String uploadLocalFile(String sourceFilePathName, String aimFilePathName) throws FileNotFoundException {
     ...
     * @return
     */
    public String uploadFile(MultipartFile multipartFile, String sufixPath) throws IOException {
        // 获取上传的文件的输入流
        ...
        // 拼接fileName
        fileName = sufixPath + "/" + datePath + "/" + fileName;
...
//        URL url = ossClient.generatePresignedUrl(bucketName, fileName, expiration);
        ...
        url.append(urlPrefix).append(fileName);
    ...
    public boolean isFileExist(String path, String fileName) {
        ...
        return ossClient.doesObjectExist(bucketName, path + "/" + fileName);
    }
     ...
     * @param
     */
    public void delelteFile(String path, String fileName) {
        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
