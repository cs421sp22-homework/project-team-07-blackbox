...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str,
                                 default='C:\JHU\\22sp\oose\\virtual-try-on\PF-AFN-main\PF-AFN_test\dataset\\')
        self.parser.add_argument('--output', type=str, default='C:\JHU\\22sp\oose\\virtual-try-on\Flow-Style-VTON-main\\test\\results\demo\\')
